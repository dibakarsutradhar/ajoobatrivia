                ...
                <section className="banner-img valign-wrapper">
                    <div className="banner-title">
                        ...
                        <div className="calltoaction pos-relative">
                            <a href="registration.html" className="btn waves-effect waves-light btn-large pos-absolute btn-border btn-border-white">Register</a>
                        </div>
                    </div>
                        ...
                        <aside className="col  l3 s12	" >
                            <div className="sticky-object">
                                <div className="hide-on-med-and-down">
                                    ...
                                    <a href="registration.html" className="btn btn-large btn-border btn-border-yellow margin-top-20">Register</a>
                                </div>
                                <div className="card ">

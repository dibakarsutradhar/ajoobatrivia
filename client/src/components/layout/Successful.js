                            ...
                            <div className="col s12">
                                ...
                                <div className="card margin-auto">
                                    <div className="card-content">
                                        <h4 className="txt-center">Registration Success</h4>
                                        <p className="txt-center">You have successfully been registered for Ajooba Trivia game.</p>
                                        <br/>
                                        <p className="txt-justify">You will be able to play compete in the event on <b>11 November 2020</b>
